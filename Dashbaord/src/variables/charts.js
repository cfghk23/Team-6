...
export const pieChartOptions = {
  labels: ["Secondary Students", "Primary Students", "Kindergarten Students"],
  colors: ["#4318FF", "#6AD2FF", "#000"],
  chart: {
    width: "50px",
  },
  states: {
